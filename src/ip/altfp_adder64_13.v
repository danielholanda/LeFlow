...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix IV" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=13 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 add_sub clk_en clock dataa datab result
...
module  fadd64_altbarrel_shift_32e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fadd64_altbarrel_shift_32e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" PIPELINE=1 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
//VERSION_BEGIN 11.1 cbx_altbarrel_shift 2011:10:31:21:13:15:SJ cbx_mgl 2011:10:31:21:14:05:SJ  VERSION_END
...
`endif
	...
	assign
		...
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //fadd64_altbarrel_shift_95g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fadd64_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	fadd64_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //fadd64_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fadd64_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //fadd64_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fadd64_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //fadd64_altpriority_encoder_rf8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fadd64_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fadd64_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	fadd64_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //fadd64_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fadd64_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	fadd64_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //fadd64_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fadd64_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	fadd64_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //fadd64_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fadd64_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fadd64_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //fadd64_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	fadd64_altpriority_encoder_rf8   altpriority_encoder24
	( 
	.data(data[31:16]),
...
endmodule //fadd64_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_uu8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fadd64_altpriority_encoder_tv8   altpriority_encoder7
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder7_q));
	fadd64_altpriority_encoder_te9   altpriority_encoder8
	( 
	.data(data[63:32]),
...
endmodule //fadd64_altpriority_encoder_uu8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //fadd64_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	fadd64_altpriority_encoder_nh8   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //fadd64_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	fadd64_altpriority_encoder_qh8   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //fadd64_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	fadd64_altpriority_encoder_vh8   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //fadd64_altpriority_encoder_fj8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_hi9
	( 
	data,
	q,
	zero) ;
	...
	fadd64_altpriority_encoder_fj8   altpriority_encoder27
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	fadd64_altpriority_encoder_fj8   altpriority_encoder28
	( 
	.data(data[31:16]),
...
endmodule //fadd64_altpriority_encoder_hi9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //fadd64_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fadd64_altpriority_encoder_nh8   altpriority_encoder41
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder41_q),
	.zero(wire_altpriority_encoder41_zero));
	fadd64_altpriority_encoder_n28   altpriority_encoder42
	( 
	.data(data[3:2]),
...
endmodule //fadd64_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fadd64_altpriority_encoder_qh8   altpriority_encoder39
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder39_q),
	.zero(wire_altpriority_encoder39_zero));
	fadd64_altpriority_encoder_q28   altpriority_encoder40
	( 
	.data(data[7:4]),
...
endmodule //fadd64_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fadd64_altpriority_encoder_vh8   altpriority_encoder37
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder37_q),
	.zero(wire_altpriority_encoder37_zero));
	fadd64_altpriority_encoder_v28   altpriority_encoder38
	( 
	.data(data[15:8]),
...
endmodule //fadd64_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_h39
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fadd64_altpriority_encoder_fj8   altpriority_encoder35
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder35_q),
	.zero(wire_altpriority_encoder35_zero));
	fadd64_altpriority_encoder_f48   altpriority_encoder36
	( 
	.data(data[31:16]),
...
endmodule //fadd64_altpriority_encoder_h39

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altpriority_encoder_ina
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fadd64_altpriority_encoder_hi9   altpriority_encoder25
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	fadd64_altpriority_encoder_h39   altpriority_encoder26
	( 
	.data(data[63:32]),
...
endmodule //fadd64_altpriority_encoder_ina

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 1278 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fadd64_altfp_add_sub_m1l
	( 
	add_sub,
	clk_en,
	clock,
...
`endif
	...
	fadd64_altbarrel_shift_32e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fadd64_altbarrel_shift_95g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fadd64_altpriority_encoder_uu8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fadd64_altpriority_encoder_ina   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fadd64_altfp_add_sub_m1l
//VALID FILE
...
module fadd64 (
	...
	fadd64_altfp_add_sub_m1l	fadd64_altfp_add_sub_m1l_component (
				.add_sub (add_sub),
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fadd64.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fadd64.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fadd64.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fadd64.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fadd64_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fadd64_bb.v TRUE
