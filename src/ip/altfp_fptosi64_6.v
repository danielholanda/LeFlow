...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=83 WIDTHDIST=7 aclr clk_en clock data distance result
...
module  altfp_fptosi64_altbarrel_shift_jrf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //altfp_fptosi64_altbarrel_shift_jrf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 402 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_fptosi64_altfp_convert_0jn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	altfp_fptosi64_altbarrel_shift_jrf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_fptosi64_altfp_convert_0jn
//VALID FILE
...
module altfp_fptosi64_6 (
	...
	wire [31:0] sub_wire0;
	reg  [63:0] temp_result0;
	reg  [63:0] temp_result1;
	reg  [63:0] temp_result2;
	reg  [63:0] temp_result3;
	reg  [63:0] temp_result4;
	...
	begin
		...
		if ((temp_result4[63] == 1'b0)&&(temp_result4[63:53] >= 11'b01000001111))
		begin
			temp_result5 <= 32'b10000000000000000000000000000000;
			modified <= 1'b1;
		end
		// round to 0 if |val| < 1
                else if (temp_result4[62:52] < 11'b01111111111)
		begin
	...
	altfp_fptosi64_altfp_convert_0jn	altfp_fptosi64_altfp_convert_0jn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_fptosi64.cmp FALSE TRUE
